...
import meteordevelopment.meteorclient.systems.modules.combat.TargetStrafe;
import meteordevelopment.meteorclient.systems.modules.combat.AntiKBPlus;
import meteordevelopment.meteorclient.systems.modules.combat.AimLock;
...
import meteordevelopment.meteorclient.systems.modules.peter.*;
...
public class Modules extends System<Modules> {
    ...
    private void initPeter(){
        add(new Freeze());
        add(new ItemFountain());
        add(new GodMode());
        add(new Spin());
        add(new TrueSight());
        add(new SaveDeath());
        add(new GamemodeAlerts());
        add(new Aquaman());
        add(new Superman());
        add(new FastStop());
        add(new BouncyBoots());
